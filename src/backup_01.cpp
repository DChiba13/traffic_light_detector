  ...
  getFiles(argv[1],".png",files_png);
    ...
    while (true)
    {
      ...
      for (int label = 1; label < num_labels_red; ++label)
      {
        ...
        cv::rectangle(camera_img, cv::Rect(red_left[label-1], red_top[label-1], red_width[label-1], red_height[label-1]), cv::Scalar(255,0,255), 2);
      }
      ...
      for (int label = 1; label < num_labels_green; ++label)
      {
        ...
        cv::rectangle(camera_img, cv::Rect(green_left[label-1], green_top[label-1], green_width[label-1], green_height[label-1]), cv::Scalar(255,255,0), 2);
      }
